...
app = tk.Tk()
app.title("AES-128 Encryption and Decryption")

plaintext_label = tk.Label(app, text="输入明文:")
plaintext_label.pack()
plaintext_entry = tk.Entry(app)
plaintext_entry.pack()

key_label = tk.Label(app, text="输入密钥 (16 位):")
key_label.pack()
key_entry = tk.Entry(app)
key_entry.pack()

encrypt_button = tk.Button(app, text="加密", command=encrypt)
encrypt_button.pack()
decrypt_button = tk.Button(app, text="解密", command=decrypt)
decrypt_button.pack()

ciphertext_label = tk.Label(app, text="Ciphertext:")
